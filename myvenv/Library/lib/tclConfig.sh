...
# installed.
TCL_PREFIX='E:/Personal Projects/End-To-End-Text-To-SQL-LLM-App-Using-Gemini/myvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/Personal Projects/End-To-End-Text-To-SQL-LLM-App-Using-Gemini/myvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/Personal Projects/End-To-End-Text-To-SQL-LLM-App-Using-Gemini/myvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/Personal Projects/End-To-End-Text-To-SQL-LLM-App-Using-Gemini/myvenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/Personal Projects/End-To-End-Text-To-SQL-LLM-App-Using-Gemini/myvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/Personal Projects/End-To-End-Text-To-SQL-LLM-App-Using-Gemini/myvenv\Library\lib\tclstub86.lib'
